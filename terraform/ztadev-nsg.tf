...
module "ztadev_eastus2_dev_prod_subnet_nsg" {
	...
	# nsgassoc
	resource "azurerm_subnet_network_security_group_association" "ztadev_eastus2_dev_ztcontroller_subnet_nsgassoc" {
		subnet_id = module.ztadev_eastus2_dev_ztcontroller_subnet.subnet_id
		network_security_group_id = module.ztadev_eastus2_dev_prod_subnet_nsg.nsg_id
	}
