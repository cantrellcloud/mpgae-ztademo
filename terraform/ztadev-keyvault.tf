...
module "ztadev_eastus2_dev_terraformsp_keyvaultaccesspolicy" {
	source = "github.com/cantrellcloud/tfaz-keyvaultaccesspolicy"
	#to_provision = local.provision_keyvaultaccesspolicy01
    key_vault_access_policy_key_vault_id            = module.ztadev_eastus2_dev_keyvault.keyvault_id
...
# keyvault01_accecsspolicy01
module "ztadev_eastus2_dev_ztademokeyadmins_keyvaultaccesspolicy" {
	source = "github.com/cantrellcloud/tfaz-keyvaultaccesspolicy"
	#to_provision = local.provision_keyvaultaccesspolicy01
    key_vault_access_policy_key_vault_id            = module.ztadev_eastus2_dev_keyvault.keyvault_id
    #key_vault_access_policy_tenant_id               = data.azurerm_client_config.current.tenant_id
...
#
# keyvault01_key01
module "ztadev_eastus2_dev_vmnix_keyvaultkey" {
    ...
    keyvaultkey_key_vault_id = module.ztadev_eastus2_dev_keyvault.keyvault_id
