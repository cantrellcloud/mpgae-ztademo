...
module "jtodev_eastus2_dev_appsvcplan01" {
   ...
   output "jtodev_eastus2_dev_appsvcplan01_id" {
    ...
    #jtodevweb    # JTODev Web Site
    module "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc" {
        source = "github.com/cantrellcloud/tfaz-appsvc"
        #to_provision = local.provision_jtodevweb
        rg_location = module.jtodev_eastus2_dev_appsvcplan_rg.rg_location
        rg_name = module.jtodev_eastus2_dev_appsvcplan_rg.rg_name
        appsvc_name = "jtodevweb"
        appsvcplan_id = module.jtodev_eastus2_dev_appsvcplan01.appsvcplan_id
        ...
        #connection_string
        connection_string_name  = "jtodevwebdb"
        connection_string_type  = "MySQL"
        connection_string_value = "Server=jtodevwebdb;Integrated Security=SSPI"
    }

        #jtodevweb_outputs
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_id" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_id
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_name" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_name
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_default_site_hostname" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_default_site_hostname
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_custom_domain_verification_id" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_custom_domain_verification_id
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_source_control" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_source_control
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_site_credential" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_site_credential
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc_identity" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtodevweb_appsvc.appsvc_identity
        }

    #jtoweb    # JTO Web Site
    module "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc" {
        source = "github.com/cantrellcloud/tfaz-appsvc"
        #to_provision = local.provision_jtoweb
        rg_location = module.jtodev_eastus2_dev_appsvcplan_rg.rg_location
        rg_name = module.jtodev_eastus2_dev_appsvcplan_rg.rg_name
        appsvc_name = "jtoweb"
        appsvcplan_id = module.jtodev_eastus2_dev_appsvcplan01.appsvcplan_id
        ...
        #connection_string
        connection_string_name  = "jtowebdb"
        connection_string_type  = "MySQL"
        connection_string_value = "Server=jtowebdb;Integrated Security=SSPI"
    }

        #jtoweb_outputs
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_id" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_id
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_name" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_name
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_default_site_hostname" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_default_site_hostname
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_custom_domain_verification_id" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_custom_domain_verification_id
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_source_control" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_source_control
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_site_credential" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_site_credential
        }
        output "jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc_identity" {
            value = module.jtodev_eastus2_dev_appsvcplan01_jtoweb_appsvc.appsvc_identity
        }
