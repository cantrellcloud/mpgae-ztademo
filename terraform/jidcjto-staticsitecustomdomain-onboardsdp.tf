...
module "jtodev_eastus2_dev_staticsitecustomdomain_jidcjto_com" {
    ...
    staticsitecustomdomain_static_site_id = module.jtodev_eastus2_dev_staticsite_onboardsdp_id
}
...
module "jtodev_eastus2_dev_dnscnamerecord_onboardsdp" {
    ...
    dnscnamerecord_record    = module.jtodev_easus2_dev_staticsite_default_host_name
}
